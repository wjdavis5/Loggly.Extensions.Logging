...
namespace Loggly
{
    public static class Events
    {
        ...
        /// <summary>
        /// Creates a new Loggly.Event, wrapped with a fluent event API
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates a new Loggly.Event pre-formatted by the specified Exception, wrapped with a fluent event API
        /// </summary>
        ...
        /// </summary>
        /// <param name="ex">A System.Exception to introspect</param>
        /// <param name="traceObject">A variable that will be traced in the Loggly.Event's Data property</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates a new Loggly.Event that dumps the specified trace variable, wrapped with a fluent event API
        /// </summary>
        /// <param name="traceObject">A variable that will be traced in the Loggly.Event's Data property</param>
        /// <returns></returns>
