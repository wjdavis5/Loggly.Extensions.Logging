...
namespace Loggly
{
    ...
    /// <summary>
    /// Represents an event that can be posted to Loggly using the Loggly.LogClient class
    /// </summary>
    public class Event
    {
        #region Properties
        ...
        /// This is typically not needed unless your application is queuing events for later posting to Loggly
        /// </summary>
