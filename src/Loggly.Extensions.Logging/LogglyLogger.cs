...
namespace Loggly.Extensions.Logging
{
    public class LogglyLogger : ILogger
    {
        ...
        public LogglyLogger( LogClient client, string name, string source,string apiKey )
            : this( client, name, source, null,apiKey )
        { }

        public LogglyLogger( LogClient client, string name, string source, Func<string, LogLevel, EventId, bool> filter,string apiKey )
        {
            m_client = client;
            m_name = name;
            m_source = source;
        ...
        public void Log<TState>( LogLevel logLevel, EventId eventId, TState state, Exception exception, Func<TState, Exception, string> formatter )
        {
            ...
            // Exception message or take the first 100 characters of the message as the Loggly text
